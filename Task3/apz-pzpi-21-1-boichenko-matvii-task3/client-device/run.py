from libs.mqtt_client import DeviceMQTTClient
import argparse
import logging
import os
import sys
...
parser.add_argument("-mac", "--machineMacAddress", action="store", dest="MACHINE_MAC", help="Mac address of machine device to connect")
...
logger = logging.getLogger(f"Client_{os.environ['MACHINE_MAC']}")
...
client = DeviceMQTTClient(logger)
